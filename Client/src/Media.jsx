...
import Media_Page1 from './Components/Media/Media_Page1'
import Media_Page2 from './Components/Media/Media_Page2'
import Media_Page3 from './Components/Media/Media_Page3'
import Media_Page4 from './Components/Media/Media_Page4'
import Media_Page5 from './Components/Media/Media_Page5'


function Media() {
  const sections = [
    { id: "career_page1 section1", component: <Media_Page1 />, ref: React.createRef() },
    { id: "career_page2 section2", component: <Media_Page2 />, ref: React.createRef() },
    { id: "career_page3 section3", component: <Media_Page3 />, ref: React.createRef() },
    { id: "career_page4 section4", component: <Media_Page5 />, ref: React.createRef() },
    { id: "career_page5 section5", component: <Media_Page4 />, ref: React.createRef() },
  ];
