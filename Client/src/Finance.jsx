...
import Finance_Page1 from './Components/Finance/Finance_Page1'
import Finance_Page2 from './Components/Finance/Finance_Page2'
import Finance_Page3 from './Components/Finance/Finance_Page3'
import Finance_Page4 from './Components/Finance/Finance_Page4'

function Finance() {
  const sections = [
    { id: "career_page1 section1", component: <Finance_Page1 />, ref: React.createRef() },
    { id: "career_page2 section2", component: <Finance_Page2 />, ref: React.createRef() },
    { id: "career_page3 section3", component: <Finance_Page3 />, ref: React.createRef() },
    { id: "career_page4 section4", component: <Finance_Page4 />, ref: React.createRef() },
  ];
