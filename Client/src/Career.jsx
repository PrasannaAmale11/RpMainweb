...
import Career_Page1 from './Components/Career/Career_Page1'
import Career_Page2 from './Components/Career/Career_Page2'
import Career_Page3 from './Components/Career/Career_Page3'
import Career_Page4 from './Components/Career/Career_Page4'
import Career_Page5 from './Components/Career/Career_Page5'
import Career_Page6 from './Components/Career/Career_Page6'

function Career() {
  const sections = [
    { id: "career_page1 section1", component: <Career_Page1 />, ref: React.createRef() },
    { id: "career_page2 section2", component: <Career_Page2 />, ref: React.createRef() },
    { id: "career_page3 section3", component: <Career_Page3 />, ref: React.createRef() },
    { id: "career_page4 section4", component: <Career_Page4 />, ref: React.createRef() },
    { id: "career_page5 section5", component: <Career_Page5 />, ref: React.createRef() },
    { id: "career_page6 lastSection", component: <Career_Page6 />, ref: React.createRef() },
  ];
